...
@section('title', 'Edit Janji Pasien')
...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Janji Pasien</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/patient-promises">Janji Pasien</a></li>
                        <li class="breadcrumb-item active">Edit Janji Pasien</li>
                    </ol>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        <form action="/patient-promises/{{ $patientPromise->id }}" method="POST" autocomplete="off" spellcheck="false">
                            @csrf
                            @method('put')
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-xl-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('patient_id') is-invalid @enderror" id="patient_id" name="patient_id" value="{{ $patientPromise->patient_id }}" readonly>
                                            @error('patient_id')
                                    ...
                                    <div class="col-md-8 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"
                                                id="patient_name" name="patient_name" value="{{ $patientPromise->patient->name }}" readonly>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group">
                                            ...
                                            <textarea id="note" name="note" class="form-control @error('note') is-invalid @enderror" rows="3"
                                                placeholder="Masukkan catatan...">{{ old('note', $patientPromise->note) }}</textarea>
                                            @error('note')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
...
<script>
    $(document).ready(function() {
        // Initial date_time
        let start = moment();
        @if(old('date_time', $patientPromise->date_time))
            startStr = "{{ old('date_time', $patientPromise->date_time) }}";
