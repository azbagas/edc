...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Diagnosis</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/diagnoses">Diagnosis</a></li>
                        <li class="breadcrumb-item active">Tambah Diagnosis</li>
                    </ol>
                </div>
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        <form action="/diagnoses" method="POST" autocomplete="off" spellcheck="false">
                            @csrf
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="disease_id" name="disease_id" class="form-control select2 @error('disease_id') is-invalid @enderror" style="width: 100%;" data-placeholder="-- Pilih penyakit --" required>
                                                ...
                                                @foreach ($diseases as $disease)
                                                    <option value="{{ $disease->id }}" @selected(old('disease_id') == $disease->id)>{{ $disease->disease_code }} - {{ $disease->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('disease_id')
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('diagnosis_code') is-invalid @enderror" required
                                                id="diagnosis_code" name="diagnosis_code" placeholder="Masukkan kode diagnosis..." value="{{ old('diagnosis_code') }}">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" required
                                                id="name" name="name" placeholder="Masukkan nama diagnosis..." value="{{ old('name') }}">
                                            @error('name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
