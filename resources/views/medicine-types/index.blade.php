    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col">
                    <div class="card">
                        <form action="/medicine-types" method="GET" id="filter-form" spellcheck="false" autocomplete="off">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-7 col-xl-5">
                                        <div class="form-group">
                                            <label for="name">Cari Jenis Obat</label>
                            
                                            <div class="input-group">
                                                <input type="text" id="name" name="name" class="form-control" placeholder="Cari jenis Obat..." value="{{ request('name') }}">
                                ...
                                <div class="row">
                                    <div class="col-md-7 col-xl-5">
                                        <a href="/medicine-types" class="btn btn-default btn-sm">
                                            Reset pencarian
                                        </a>
                                    </div>
                                </div>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="5" class="text-center">
                                                <span>Tidak ada jenis Obat.</span>
                                            </td>
                                        </tr>
                                    @endforelse
            ...
            <div class="row">
                <div class="col">
                    {{ $medicine_types->onEachSide(1)->links() }}
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('.delete-button').click(function(event) {
            ...
            Swal.fire({
                title: "Anda yakin ingin menghapus jenis Obat ini?",
                icon: "warning",
