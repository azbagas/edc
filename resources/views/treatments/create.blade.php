...
@section('header')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Tambah Tindakan</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        <form action="/treatments" method="POST" autocomplete="off" spellcheck="false">
                            @csrf
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="treatment_type_id" name="treatment_type_id" class="form-control select2 @error('treatment_type_id') is-invalid @enderror" style="width: 100%;" data-placeholder="-- Pilih jenis tindakan --" required>
                                                ...
                                                @foreach ($treatment_types as $treatment_type)
                                                    <option value="{{ $treatment_type->id }}" @selected(old('treatment_type_id') == $treatment_type->id)>{{ $treatment_type->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" required
                                                id="name" name="name" placeholder="Masukkan nama tindakan..." value="{{ old('name') }}">
                                            @error('name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
