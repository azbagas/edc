                                    ...
                                    <div class="col ml-xl-5">
                                            ...
                                            <div class="col">
                                                <div class="form-group mb-1">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="is_pregnant" name="is_pregnant" value="1" @checked(old('is_pregnant', $appointment->patient_condition->is_pregnant) == 1)>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group mb-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="is_diabetes" name="is_diabetes" value="1" @checked(old('is_diabetes', $appointment->patient_condition->is_diabetes) == 1)>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <div class="form-group mb-1">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" id="is_hypertension" name="is_hypertension" value="1" @checked(old('is_hypertension', $appointment->patient_condition->is_hypertension) == 1)>
                                            ...
                                            <div class="col">
                                                <div class="form-group mt-1">
                                                    <textarea id="note" name="note" class="form-control @error('note') is-invalid @enderror" rows="3"
                                                        placeholder="Kondisi lainnya...">{{ old('note', $appointment->patient_condition->note) }}</textarea>
                                                    @error('note')
                                                        <span class="invalid-feedback">{{ $message }}</span>
                                                    @enderror
                                                </div>
