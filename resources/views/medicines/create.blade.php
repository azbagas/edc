        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    ...
                    <div class="card">
                        <form action="/medicines" method="POST" autocomplete="off" spellcheck="false">
                            @csrf
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="medicine_type_id" name="medicine_type_id" class="form-control select2 @error('medicine_type_id') is-invalid @enderror" style="width: 100%;" data-placeholder="-- Pilih jenis obat --" required>
                                                ...
                                                @foreach ($medicine_types as $medicine_type)
                                                    <option value="{{ $medicine_type->id }}" @selected(old('medicine_type_id') == $medicine_type->id)>{{ $medicine_type->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" required
                                                id="name" name="name" placeholder="Masukkan nama obat..." value="{{ old('name') }}">
                                            @error('name')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('dose') is-invalid @enderror"
                                                id="dose" name="dose" placeholder="Masukkan Dosis..." value="{{ old('dose') }}">
                                            @error('dose')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control @error('stock') is-invalid @enderror" required
                                                id="stock" name="stock" placeholder="Masukkan stok..." value="{{ old('stock') }}">
                                            @error('stock')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('unit') is-invalid @enderror" required
                                                id="unit" name="unit" placeholder="Masukkan Satuan..." value="{{ old('unit') }}">
                                            @error('unit')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="price" type="text" name="price" class="form-control rupiah" placeholder="0,00" value="{{ old('price') ? change_decimal_format_to_currency(old('price')) : '' }}" required>
                                            </div>
                                        </div>
